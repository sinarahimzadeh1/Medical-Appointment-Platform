        ...
        <div class="col-xl-12 col-12">
          <div class="box">
            <div class="box-header d-flex justify-content-between align-items-center">
              <h4 class="box-title"> ویرایش پست</h4>
              <?php
            ...
            <div class="box-body table-responsive">
              ...
              <form method="post" action="<?= url('admin/post/update/' . $id) ?>" enctype="multipart/form-data">
                ...
                <label for="image">تصویر قبلی پست :</label>
                <img class="img-thumbnail img-thumbnail-2"  src="<?= asset($post['image']) ?>" alt="">

                <div class="form-group">
                  <label for="published_at">منشتر شده در :</label>
                  <input data-jdp type="text" class="form-control" id="published_at" name="published_at" value="<?= $post['published_at'] ?>" required autofocus readonly>
                </div>

                <div class="form-group">
                  <label for="summary">خلاصه</label>
                  <textarea class="form-control" id="summary" name="summary" placeholder="خلاصه ..." rows="3" required
                    autofocus><?= $post['summary'] ?></textarea>
                </div>

                <div class="form-group col-12">
                  <label for="body">بدنه (متن اصلی)</label>
                  <textarea class="form-control" id="body" name="body" placeholder="متن ..." rows="5" required
                    autofocus><?= $post['body'] ?></textarea>
                </div>

                <button type="submit" class="btn btn-primary btn-sm fs-5">انتشار <i
