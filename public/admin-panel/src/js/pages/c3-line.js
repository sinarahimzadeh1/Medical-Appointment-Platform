...
$(function() {
    ...
    setTimeout(function() {
        t.load({
            columns: [
                [' داده 1', 230, 190, 300, 500, 300, 400]
            ]
        })
    ...
    var o = c3.generate({
        ...
        data: {
            ...
            columns: [
                ...
                [' داده 1', 30, 200, 100, 400, 150, 250],
                [' داده 2', 130, 300, 200, 300, 250, 450]
            ]
        },
        grid: {
            y: {
    ...
    setTimeout(function() {
        o.load({
            columns: [
                [' داده 1', 100, 250, 150, 200, 100, 350]
            ]
        })
    }, 1e3), setTimeout(function() {
        o.load({
            columns: [
                [' داده 3', 80, 150, 100, 180, 80, 150]
            ]
        })
    }, 1500), setTimeout(function() {
        o.unload({
